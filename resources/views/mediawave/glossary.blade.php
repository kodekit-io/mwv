...
<main class="">
    <div class="md-container">
        <div class="md-card hoverable uk-width-1-1">
            <div class="md-card-toolbar">
                <h1 class="md-card-toolbar-heading-text">Glossary</h1>
            </div>
        	<div class="md-card-content">
                <dl class="uk-description-list">
                    <dt>Net Sentiment (NS)</dt>
        			...
        			<blockquote><strong>NS 1</strong> = Total mention yang positif + Total mention yang netral - Total mention yang negative <strong>NS 2</strong> = Total mention yang positif - Total mention yang negatif</blockquote>
        			...
        			<blockquote><strong>NBR</strong> = % Total mention yang positif - % Total mention yang negatif</blockquote>
        			...
        			<blockquote><strong>BTF</strong> = (% Total mention yang positif + % Total mention yang netral) - % Total mention yang negatif</blockquote></dd>
        			...
        			<blockquote><strong>EMSS</strong> = (% Total mention yang positif dari brand / % Total mention positif dari kategori) = (% Total mention yang netral dari brand / % Total mention yang netral dari kategori) - (% Total mention yang negatif dari brand / % Total mention yang negatif dari kategori)</blockquote></dd>
        			...
        			<blockquote><strong>SIM SCORE</strong> = (% Total mention yang positif dari brand / % Total mention dari kategori) + (% Total mention yang netral dari brand / % Total mention dari kategori) - (% Total mention yang negatif dari brand / % Total mention dari kategori)</blockquote></dd>
        			<hr><dt>Buzz (BZ)</dt>

...
class ProjectVideoController extends Controller
{
    ...
    public function detail(Request $request, $projectId)
    {
        ...
        $wordCloud = $this->chartService->wordCloud($projectId, 5, $brands, $startDate, $endDate);
        $viewInfluencer = $this->chartService->viewInfluencer($projectId, 5, $brands, $startDate, $endDate);

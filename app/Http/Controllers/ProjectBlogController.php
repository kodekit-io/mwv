...
class ProjectBlogController extends Controller
{
    ...
    public function detail(Request $request, $projectId)
    {
        ...
        $wordCloud = $this->chartService->wordCloud($projectId, 3, $brands, $startDate, $endDate);
        $viewInfluencer = $this->chartService->viewInfluencer($projectId, 3, $brands, $startDate, $endDate);
